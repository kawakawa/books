...
- 第三部　評価
    ...
    - アレグザンダーの「全体」とは
        ...
        - 最優先のルールを抽象的な表現に変えて、全体性について強調させてみます
            - それぞれの建物は、その空間がもつ全体の数が増えていくように、選択され、配置され、計画され、形づくられ、細部を与えられなければならない。
            
        - アレグザンダーは、これら全体性へと方向づけられるプロセスが、現行の都市開発の方法とは全く違った結果を生み出し、今日の都市が抱える問題を改善するのに大きな効果があることを確信する
        - 都市の構造が上からの押し付けではなく、個々の建物の計画とそこで生活から作られるときに初めて、まちづくりのプロセスが全体性を生み出すことができるというのです。
        - 全体性は、大きな都市構造と都市の公共空間が様々な小さな計画から作り出されるときのみ生まれるのです。
        
        - アレグザンダーは、「全体性」「中心」「ビジョン」という言葉を呈示することで、現在に私たちが「安全」「便利性」「採算性」「用途の鈍化」「景観」という言葉で計っている街の見方に新たな共通の土俵を作り出そうとしている
        
- 訳者あとがき
    - 部分と全体に関してのA・ケスラーたちの「ホロン」概念、D・ボームやK・H・プリブラムの「ホログラフィー理論」などがパタンを知るてかがりとなる
    - パタンが相互に作用しあって大きな全体になることは「自己組織化」するシステムに近い
    - その成長する形については、R・トムの「カタストロフ理論」やB・マンデブローの「フラクタル理論」なども示唆を与えてくれる
    - さらにその底に横たわるものは、G・ベイトソンの「スカシティック」や、プロセスやM・ポランニーの「暗黙知」と「創発」するプロセスです。
    - ホワイトヘッド
        - 彼は、自らの有機体の哲学と規定し「過程と実在」を著した
        - その影響を受けた進化学者ヤンツはプロセスを「システムの進化を主軸とするプロセス中心の世界観では、自己決定と自己有機体化が主役を演じる
        - この舞台では、特定の構造の安定ではなく、システムのダイナミクスがすなわち倫理である
        - 進化するのは実体ではなく、プロセスの網であり、環境と相関しつつシステム内でダイナミックに有機体化するシステムだ」と説明している
        
    - 幾何学的性質、そしてプロセスへ
        - 「形は機能にしたがう」という命題は、現代にまで引き継がれたモダニズムの思想を表現してきました。
        - アレグザンダーも内容こそ異なれど、パタンという機能ユニットがその最も相応しい性質をもち、パタンどうしの相互作用で全体の形の性質が決まるとしてきました。
        - アレグザンダーがパタン・ランゲージの次に呈示したのは、そのような形に関する性質でした。
            - ここでいう性質は、モノや空間相互の間の幾何学的な言葉で表される関係についてです。
        - そして、この性質を決めるのは人の持つ「深い情感(ディープ・フィーリング)」です
        - ここでもパタンと幾何学的性質は相補的な関係にあります。
        - 機能と人との関係を明らかにするパタンと、形と人（深い情感）との関係を抽出した幾何学的性質が、人を媒介として形と機能の関係を作っていきます。
        - ここまでくれば、今までの静的な関係性の追求に加えて、動的な関係性、つまり動的平衡システムを持つより自然の姿に近い都市や建築の在り方、建設の在り方へと進んでいくことになります。
        
        - 都市や建築のようなモノの持つ動的なシステムが本書にもある斬新的成長であり、
        - モノと人との関係の動的システムが本書の中心的課題であるセンタリング・プロセスです。
            
        - 作り手であるユーザと専門家が建設プロセスのなかで、作るシステムがアーキテクトビルダーであり、
        - 直営（CM＝コンストラクション・マネージャ）方式、ユーザ参加となります。
       
        - プロセスこそがすべてに優先する、という思想はアレグザンダーの初期の頃の論からも窺うことができます。
        - ホワイトヘッドがものの存在を実体としてよりも、プロセスとしてとらえる見方を呈示しています。
        
        - センタリング・プロセスは、すべてのものに中心があり、かつ全体になり得る、
        - しかも、すべてが全体であるとともに、中心であるという前提に立っています。
        - 還元論でもなく全体論でもない、両者を止揚したシステム論への発展がみられます。
        
        - ユーザ参加、アーキテクトビルダー、直営（CM)方式のもつ問題が最も鮮明にでいたのが盈進プロジェクトです。
        - ゼネコンが分業と図面という方法で極めて静的なシステムに対して、ユーザも含んで建設プロセスを作っていこうとするアレグザンダーの動的なシステムはぶつかり合いました。
        
        - アレグザンダーは、ビジョンのない経済効率一辺倒の開発は、人を感動させないし、環境の全体性を生み出すことはできないと言っています。
        - アレグザンダーは、個人を見失うような大きな夢でなく、等身大の小さなビジョンこそが必要と言っています。
        - さらに小さなビジョンなら、相互に作用しあいながら、全体として成長できるという自己組織化するシステムになりうるはずです。
        - ここにも、アレグザンダーに一貫するシステマティックな思考が考えられます。
        
        - アレグザンダーは、機能とは何かという問いに答えて、（何かが）人との関係を確率するためのものだと答えています。
        - モノとモノ、モノとイメージの関係ではなく、人の精神に直接関係しなければならないということです。
        - その人の生活に直接関係するビジョンは、まさに人と環境を関係づける上での最も大きな要素であり、ビジョンを明確にすることは生活とモノ、空間との機能を明確にすることなのです。
        - ここでもアレクサンダーの一環した機能主義的な態度が読み取れます。
