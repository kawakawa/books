...
- 像と写像形式
    ...
    - 像は一つの事実である
        - 像がまさに模型という一個の対象（あるいは対象の集合）として捉えるのと同時に、諸対象（諸々の鉄道模型、レゴブロック、音声、文字、等々）が、特定空間内で、特定の仕方で配置され、関係し合っていることそれ自体である、という点も重要である。という点も重要である。
...
- 世界のあり方と、世界があること
    - ア・プリオリに要素命題を挙げることは不可能である。
        ...
        - それゆえ、（T5.55651）「経験的な実在は、対象の総体によって限界づけられている。
        
        - しかし、その「対象」とは何か、また「要素命題」とは何かを、我々がア・プリオリｊな仕方で挙げることは決してできない。
        - どんな要素命題が存在するかは、我々が具体的に何事かを経験し、それらを論理的に有意味な命題として様々に語り、そして、それらを論理に従って分析していくことによって、はじめて取り出される。
        - つまり、（T5.557）「どんな要素命題が存在するかは、論理の適用によって決まる」。
        - それゆえ、（同節）「適用のうちにあることを、論理が先取りすることはできない」のである。
        
        - そして、（T5.524）「対象が与えられている時、それとともにすべての対象も与えられている」ということと、
        - および（同説）「要素命題が与えられている時、それとともに、すべての要素命題も与えられている」
        - ということは、 「究極の言語」が文字通りの全体論的構造をもつということである。
        - ある一つの要素命題を特定することは、同時に他のすべての要素命題を特定することにほかならない。
        - 言い換えれエバ、すべての要素命題を挙げることができない限り、ある一つの要素命題を挙げることも不可能だということだ。
        - そして、すべての要素命題をア・プリオリに挙げることなど、原理的に不可能なのである。
        
    - 世界があるという、根源的な「経験」
        - （T5.5563）「我々の日常言語のすべての命題は、実際、そのあるがままで、論理的に完全に秩序づけられている」
        - ともあれ、肝心なのは、世界の具体的なあり方は、経験的にのみ知られる、ということだ。
        - 言い換えれば「自自はしかじかである」という、経験の内容をア・プリオリに、つまり経験に先立って、語ることは当然不可能なのである。
        
        - しかし、世界の具体的なあり方を経験する前提となる、いわば別の種類の「経験」があるように思われる。
            - それは、世界があるということの経験である。
            - 世界があることは、世界のあり方に先立つ。
            - 我々は、世界があることを経験し、そのことを語りうるかに見える。
            - 例えば、我々はときに、世界があることに驚く。
            - その驚きは、「なぜ世界は存在するのか」とか、「なぜ、何もないのではなく、何かがあるのか」といった問いの形で提示されることもある。
            - 哲学の世界では、この驚きと問いが繰り返し表明されてきた。
            
        - 「世界が存在する」というのは、無意味な命題もできである。
            - 「机の上にペンがある」や「新幹線が東京駅に停車している」こと等など、すべての事態から帰結してしまう。
            - 言い換えれば、すべての事態を許容し、すべての論理的場を指定してしまう。
            - というのも、いかなる世界のあり方も、成立しているのであれ、成立していないのであれ、世界が存在することを前提にしている（世界が存在することを含んでいる）からである。
            - つまり、トートロジーが、可能な事態をすべて許容するがゆえに何事も語っておらず、命題と命題もどきの際に位置するのと同様に、「世界が存在する」という命題も、そもそも真正の命題とはいいがたい。
            
            - 有意味な命題
                - ＝論理に従い（言語と世界の論理的性質を反映し）何事かを語っている
        ...
        - 世界があることは、世界のあり方に先立ち、論理に先立つ
            - 我々が語る命題も、それが描き出す経験的な内容も、常にすでに論理に従っている。
            - その意味で、（T5.552）「論理はどんな経験にも、すなわち、何かがしかじかとという仕方であるという経験にも先立つ」
            
            - ただし、この「先立つ」というのは、あらゆる経験に時間的に先立って、「論理」「論理的性質」という何らかの対象が、それ自体として独立に存在する、ということではない。
            - 論理は、その適用である有意味な命題において、おのずと示されている。
            - 言い換えれば、個々の有意味な命題が語られるとき、そこで反映されているのが、論理である。
            - つまり、論理は、その適用から離れて、それ以前に何らかの対象として、存在しうるものではないのでうｓ。
            
            - 世界があることは、世界のあり方に先立つ。さらに、論理にも先立つ。
            - 逆に言えば、（T5.552）「論理は、あり方には先立つが、あることには先立たない」
            
            - 論理は世界の存在には先立たない（＝論理は、世界の存在の可能性の条件ではない）
            - 他方、世界が存在しなければ、それが様々なあり方をするという事はあり得ない。
            - また、論理は、そのように適用される以前に、それ自体として存在するものではありえない。
            - したがって、世界の存在は、論理に先立つのである。
            
            - まとめると、世界があることは超越論的である。
            - すなわち、世界のあり方に先立ち、論理にも先立つ、それらの可能性の条件である。
            - そして、そうであるがゆえに、我々はこの条件について、いかようにも語りえない。
            - その意味で、世界があることは神秘なのである。
            
- コラム（２）
    - 論理額講話
        - 絶対的価値の探求としての、論理学
            - 「論理学」という探求は、煎じ詰めて言えば、絶対的価値の探求だと、ウィトゲンシュタインは言う。
            - たとえば、ある街にいくのに「正しい道」「よい道」と話すことがあるが、
            - この場合での「正しい道」「よい道」は、特定の目的によって条件づけられた価値、手段としての価値（＝相対的評価）を意味している。
            - 他方、我々はまた、たとえば人として、「正しい道」「よい道」について、語ることもある。
            - この場合、我々は、他の目的によって条件づけられることのない。
            - それ自体が内在的にもつ価値（＝絶対的価値）に言及している            

- 独我論と哲学的自我
    - （T5.6）「私の言語の限界が、私の世界の限界を意味する」
    - （T5.62）
        -　独我論の言わんとすることは全く正しい。ただし、それは語ることができず、示されるものなのである。
        - 世界が私の世界であるということは、この言語（私が理解する唯一の言語）の限界が、私の世界の限界を意味するということに示されている。
    - （T5.633）
        - 事情は眼と視野の関係と同じだと君は言う。しかし、君は実際に眼をみることはない。
        - そして、視野のうちにあるどんなものからも、それが眼によって見られているという事は推論されない。
    - （T5.64）
        - ここにおいて、独我論を徹底させれば、純粋な実在論と一致するという事が見て取られる。
        - 独我論の自我は空間的広がりを持たない点へと収縮し、自我に対応する実在が残される。

    - 独我論が生まれるところ
        - 我々ではなく、「私」なのではないだろうか。
        - 像をこしらえ、それを現実と比較しているのは、他ならぬこの私ではないだろうか。
        - 他者がどのようなことを考え、世界をどのように見ているかは、究極的には知りえない事柄である。
        - 世界とは、他ならぬこの私が見ている世界であり、世界の可能性とは、他ならぬこの私が思考する可能性なのではないだろうか。
        
        - 世界の可能性は、そもそも誰によって語られるのかと問うとき、やはり独我論が姿を現すことになる。
        - すなわち、世界の可能性は、他ならぬ、この私がどのような命題を語りうるかということに依存している、という考えである。
      
    - 主体は世界の限界そのものであり、世界のなかには属さない
        - 世界とは、他ならぬこの私が知覚している世界である。
        - 世界はこの私に対して開かれている。
        - また、世界の可能性も、この私がどのような命題をかたりうるか、どのような像をこしらえうるのか、ということに依存している。
        - その意味で、世界は私の世界である。
        - 独我論は、おおよそこうした形態をとる。
        
        - なぜ、ウィトゲンシュタインは独我論は語りえないというのだろうか。
            - 鍵となるのは、（T5.63）「私は、私の世界である」という見解だ。
            - 私は、私の世界そのものである。
            - 言い換えれば、私は世界のなかに存在するのではないとウィトゲンシュタインはは主張するのである。
            
            - 「私が見出した世界」として、私の外側も内側も、すなわち、私が知覚した世界のあり方など具体的に、網羅的に書き込んでも書き込めない存在が浮き彫りになる。
                - それは、世界のあり方を見出している他ならぬこの私の存在である。
                - 私の外見や内面を見つめている、私それ自体は決して対象化しえない。
                - （T5.632)「主体は世界に属さない。主体は世界の限界なのである」
                
    - 主体は視野のうちには現れない
        - （T5.631）「思考し表象する主体なるものは存在しない」
        - 私は絵をえがくとき、その中に私を描いたとしても、それは「描かれた私」にほかならない。
        - 絵を描く私は、その絵の中に原理的には登場しえない。
        - 私とは、いうなれば私が描く絵それ自身であり、私の限界とは、私が描けれる絵の限界それ自体である。
        - つまり、私とは（T5.641）「世界の部分ではなく、世界の限界」なのだ。
        
- 説明の終端
    - 因果関係は必然的ではなく、偶然的なものである。
        - 明日も太陽が昇るということすら、今まで太陽が昇って来たという経験の蓄積からくることであり、必然的な帰結の事柄ではない。
    - 世界記述の形式それ自体を、世界のあり方のひとつとして語ることはできない
        - 何らかの因果的関係を語る事なしに、何らかの因果的な記述の形式に従う事なしに、世界の諸事実が具体的にいかに生じるかを記述することは困難である。
        - ただ、その形式は唯一つとは限らない。
        - むしろ我々は、記述の目的等に応じて、多様な形式を使い分けているとも言えるのである。
        
    - 世界記述の各形式は、説明の終端である。
        - たとえばニュートン力学は、あくまでも、必然的関係が存在するという作業仮設、そうした必然的関係が行き渡るものとして、世界の諸事実の一切を記述するという計画に基づいて、その計画を具体的に実行していく試みにほかならない。
        - そして、この試みにとって肝心なのは、世界の諸事実をよりきめ細かく記述するとか、シンプルに記述するとか、実り豊かな成果を実際に出すことであり、当の作業仮設ないし、計画が本当に正しいかどうか、
        - つまり、他の作業仮設ないし、計画はみな間違っているかどうか、という点に白黒つけることではないのである。
...
- 意思と世界
    ...
    - 相対的価値は語りうるが、絶対的価値は語りえない
    - 論理や美は語りえない
        - (T6.41）「世界の中には価値は存在しない」
        
    - 論理は超越論的である
        - 我々は、目的と手段の連鎖の下で、また、それ以上の目的を設定できない絶対的価値との関係の下で、世界のあり方を捉え語る。
        - 逆言えば、何らかの価値も前提にすることなしに、世界のあり方について語るのは、困難ということだ。
        - しかし、その肝心の価値それ自体は、有意味な命題という形で語ることができないのである。
        
    - 世界の外にありつつ、世界全体の強弱を変える意思
        - 世界の外に置かれるべきものとして、世界の中の事実に意味や価値を見出す働きそのものである。
            - ウィトゲンシュタインは「意思」と呼んでいる
            - （T6.423）「論理的なものの担い手たる意思については、語りえない」
        - 私がどのようなものに絶対的価値を認め、その価値観からどのように世界を認識するかに応じて、世界の明暗が変わる。
        - すなわち、ある価値を反映しているものとして、世界全体が明るく照らされたり、暗い陰影をまとうことになる。

- 永遠の相の下に
    - （T6.4311）「死は人生の出来事ではない。人は死を経験しない」
        - 人は自分の死の前後を見届けることはできない
        
    - 「世界がある」ことの無意味と意味
        - （T6.44)「世界が如何にあるかが神秘なのではない。世界があるという、そのことが神秘なのである」

- 投げ捨てるべき梯子としての「論考」
    - 「論考」の序文
        - 「私の仕事は2つの部分からなっている。ひとつはここに提示したこと、そしてもうひとつは、ここに書かなかったことのすべてだ。」
        - 「そして重要なのは、この第２の部分である」

    - 「梯子」のもうひとつの側面。おのれの存在の意味を消滅させるための書物としての「論考」
        - たとえば、虫歯の治療を行う医者は、この病を治すために努力するが、仮にすべての人の虫歯が完全に治り、
        - 今後虫歯になる人も全く現れなくなるとしたら、「虫歯を直す医者」という存在は意味を失うことになる。
        - 同じことが、哲学という病の治療を行う「論考」にも言えるのである。
