...
- 共有ビジョン
    - ビジョンとは、「何を創造したいのか・どうありたいのか」に対する回答である
    - ビジョン構築は、経営トップだけの仕事ではない。
        - 組織の人々がそこに参加し、個人のビジョンと組織のビジョンを対話によって結び付けていくプロセスのなかで「共通」のものになっていく
            - その活動により個人は全体と結ばれる
    - 共有ビジョンを構築するプロセスは価値を共有したコミュニティを生み出すことで、社員と会社の関係を変化させ、互いに信頼のなかった人たちが一緒に働き始めることを可能とする
    
    - 意味の共有化に向けて
        - 共有ビジョン構築するための戦略は、下記にあげる重要な指針を中心につくられる
            - すべての組織はその存在理由を示す深い意味を持つ目的がある
                - 個人の人生目的が完全に判らないのと同じように、組織の目的も十分に理解することはできない
                - しかし、絶えず湧き上がってくる目的意識に耳を傾けようと決意することは個人やコミュニティを「受け身の姿勢」から「創造的な姿勢」へと変化させる重要な選択である
                - 共有かされた意味とは「何が大事か」「それはまぜなのか」ということに対する共通の認識である。
                    - 従来の組織においてメンバーが知っている意味といえば、組織の実験を握る中枢の意思に従って、上から階層を通じて与えられたものである
                        - 上から与えられた意味を受け取ったメンバーは同意こそしても、積極時に取り組もうとしないだろう
                        
            - 共有ビジョンを可能にするインフラ
                - 組織とは、共有化された意味を囲んで形成されたコミュニティが、いくつも重なり合ってできたものである
                    - 組織をコミュニティの集まりとして捉える
                - 共有ビジョンは、人と人との関りを通じて広がるものである。
                    - 組織内の様々なコミュニティをつなぐために、インフォーマル（非公的）・ネットワークに頼ることになる
                        - インフォーマルネットワークとは、互いが気楽に自由に話し合うことができるコミュニティの通路
                        - PCでのネットワークでは、意味の共有化を図るには不十分で、互いが本当に関心をもっているものを話し合うときは、直接会って話す必要がある
                        
            -  ビジョン、価値観、目的（またはミッション）、目標
                - 共有ビジョンは組織の求心力の一要素でしかなく、組織を導く諸原理の核心は「目的や運命をともにする感覚」なのである
                    - ビジョン
                        - 自分達が望む未来のイメージ
                        - ビジョンとは自分が生み出そうと考えている未来の姿を、あたかもそれが今おきているような現在形で描いたものである。
                        - ビジョン・ステートメントは、どこに行きたいのか、そこに到着したときはどうなるのかを示すものである
                        - ビジョンのイメージが細部に至るまで明確に描かれていて、視覚に訴える力が強いほど、人を駆り立てる力も強くなる
                    - 価値観
                        - 目指す場所までどのように旅するのか
                        - 価値観は、私たちがビジョンに向かって日々の営みにをおくるうえで、どのような行動するのか価値基準となるものである。
                    - 目的またはミッション（使命）
                        - 組織は何をするために存在しているのか
                    - 目標
                        - 近い将来に到達する一里塚
                        - 遠いビジョンだけでなく、具体的で到達可能な目標
            ...
            - ビジョンに向かう5つの出発点
                ...
                - 命令は責任者のリーダーシップへの依存が高い
                - 協創はメンバーに要求されるリーダーシップへの依存が高い
                - 命令⇒協創へ徐々に割合が変わっていく              
                
- チーム学習
    - チーム学習はチーム・ビルディングとは異なり、メンバーのスキルやコミュニケーションスキルを高めるためのものではない。   
    - アライメント＝全体としての機能
    - アリメントを育てるとは、互いの考え方や感じ方を知っているメンバーが協力と一体感をもって、相乗効果を高めながら考えたり、行動したりするようなチームとしての能力を高めることである
    - チーム
        - 結果を出すために互いに必要とする人々の集まり
    - チーム学習は、自己実現（マスタリー）や自分を知ることから始まり、メンバーを知り、アライメント（協働体制）を育てることも含んでいる
    - ファシリテーターの必要性
    - チームに学習をもたらす対話のルール
        - 心理的安全性につながる
    - ダイアログ
        - 日常や経験、当然と受け止めている事がらについて、皆で探求し続ける事
        - 探求の為の「場」「器」
        - フェーズ１
            - 器の不安定
        - フェーズ2
